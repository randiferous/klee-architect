                ...
                <div className="row">
                    <div className="col-md-4 mb-4">
                        <div className="card service-card shadow-lg rounded-3">
                            <img src="/public/images/residential.jpg" className="card-img-top" alt="Service 1" />
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="card service-card shadow-lg rounded-3">
                            <img src="/public/images/commercial.jpg" className="card-img-top" alt="Service 2" />
                            <div className="card-body">
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="card service-card shadow-lg rounded-3">
                            <img src="/public/images/consulting.jpg" className="card-img-top" alt="Service 3" />
                            <div className="card-body">
