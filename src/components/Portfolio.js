            ...
            <div className="container text-center">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="portfolio-card">
                            <div className="portfolio-img-wrapper">
                                <img src="/public/images/mixed-development.jpg" alt="Mixed-Use Development" className="portfolio-img" />
                    ...
                    <div className="col-md-4">
                        <div className="portfolio-card">
                            <div className="portfolio-img-wrapper">
                                <img src="/public/public/images/parking-garage.jpg" alt="Parking Garage" className="portfolio-img" />
                                <div className="portfolio-img-overlay"></div>
                            </div>
                    ...
                    <div className="col-md-4">
                        <div className="portfolio-card">
                            <div className="portfolio-img-wrapper">
                                <img src="/public/images/minimalist-home.jpg" alt="Minimalist Home" className="portfolio-img" />
                                <div className="portfolio-img-overlay"></div>
                            </div>
